...
public class DashboardClient extends JFrame implements ActionListener
{
    ...
    private ImageIcon accepted = new ImageIcon("C:\\Users\\Owner\\OneDrive\\Documents\\NetBeansProjects\\ArtStreamFinal\\src\\main\\java\\com\\mycompany\\artstreamfinal\\accepted-removebg-preview.png");
    private ImageIcon pending = new ImageIcon("C:\\Users\\Owner\\OneDrive\\Documents\\NetBeansProjects\\ArtStreamFinal\\src\\main\\java\\com\\mycompany\\artstreamfinal\\pending-removebg-preview.png");
    ...
    private JPanel[] grids = new JPanel[4];
    private JLabel[] profileLabels = new JLabel[4];
    ...
    private JButton[] viewArtists = new JButton[4];
    ...
    public DashboardClient() {
        ...
        JLabel label = new JLabel("Find Artists");
        label.setFont(new Font("Segoe UI", Font.PLAIN, 25)); // Increase font size for combo box
        ...
        for (int i = 0; i < grids.length; ++i) {
            ...
            Image iconNewSize = icon.getScaledInstance(200, 200, Image.SCALE_SMOOTH);
